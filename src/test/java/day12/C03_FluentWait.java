...
public class C03_FluentWait extends TestBase {
    ...
    public void fluentWaitTest() {
        ...
        Wait<WebDriver> wait = new FluentWait<>(driver)
                ...
                .withMessage("IGNORE EXCEPTION")     //mesaj yazdirabilirim bu zorunlu degil
                .ignoring(NoSuchDynamicMethodException.class); //exception'u handle et umursama! bu da zorunlu degil
