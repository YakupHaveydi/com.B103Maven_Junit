...
public class P2_Cookie extends TestBase {
    /*
                                    Cookies(Çerezler)
    ...
    public void test01() {
        ...
        System.out.printf("Cookilerin Sayisi = "+cookies.size());


        //Sayfadaki cookie lerin isim ve değerlerini yazdırınız
        cookies.stream().forEach(t-> System.out.println(t.getName()+" "+ t.getValue())); //lambda ile yazildi
