...
public class C02_TimeOutException extends TestBase {
    ...
    Explicit wait kullanıldığında ve element bulunamadığında alınır -> TimeOutException
    Explicit wait & yanlış locater -> TimeOutException
    Explicit wait & doğru locater & süre yeterli değil -> TimeOutException
    Explicit wait & dogru locater & süre yeterli & iframe var -> TimeOutException
